<header class="home-website-header">
            <div class="home-website-header-offer">
                <div class="home-website-header-offer-bar standard-header">Nasza firma
                    <span>Dowiedz się o nas jak najwięcej!</span>
                </div>
                <div class="home-website-header-offer-container">
                    <div class="home-website-header-offer-container-hider about-hider"></div>
                    <img class="home-website-header-offer-container-img scaler11" src="img/pictures/clipped/about-flowers.png">
                </div>
            </div>
